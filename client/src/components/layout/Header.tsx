      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
          ...
          <nav className="flex flex-col sm:flex-row gap-4 md:items-center text-sm md:gap-8">
            ...
            <Link href="/cse-divident-history" className="font-medium hover:text-amber-400 transition-colors flex items-center gap-1.5">
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="3" width="18" height="18" rx="2" ry="2"/>
                <path d="M3 9h18"/>
                <path d="M3 15h8"/>
            ...
            <Link href="/sri-lanka-fd-rates" className="font-medium hover:text-amber-400 transition-colors flex items-center gap-1.5">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 17V9h16v8H4zm2-2h12v-4H6v4zM3 7h18V5H3v2zm3 10h12v-1H6v1zm0 2h6v-1H6v1z"/>
              </svg>
              <span>FD Rates</span>
            </Link>
            <Link href="#calculator" className="font-medium hover:text-amber-400 transition-colors flex items-center gap-1.5">
              <Calculator className="h-4 w-4" />
              <span>Calculator</span>
            </Link>
            <Link href="/" className="font-medium hover:text-amber-400 transition-colors flex items-center gap-1.5">
