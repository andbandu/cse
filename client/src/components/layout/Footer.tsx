      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-6 flex space-x-4">
              <a
                href="#"
                className="text-slate-300 hover:text-primary-400 transition-colors bg-slate-700/50 p-2 rounded-full hover:bg-slate-700"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span className="text-slate-300 text-sm">
                  123 Financial Street, Colombo 03, Sri Lanka
                </span>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700/50 text-center">
          <p className="text-slate-400 text-sm">
            &copy; {new Date().getFullYear()} ColomboStockExchange.info. All
            rights reserved. Data is for informational purposes only.
          </p>
        </div>
      </div>
    </footer>
