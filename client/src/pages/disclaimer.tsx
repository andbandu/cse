      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="space-y-6">
          ...
          <section>
            ...
            <p>
              The content on this website is not intended to be investment
              advice. We do not provide personalized investment advice. The
              information is provided as an educational resource only.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              principal. Past performance does not guarantee future results. You
              should always conduct your own research and consult with a
